            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mt-8 sm:mt-10">
              ...
              {category.tools.map((tool) => (
                ...
                <Link
                  key={tool.href}
                  href={tool.href}
                  className="group border rounded-2xl p-5 sm:p-6 hover:shadow-lg hover:border-sky-200 transition-all duration-300 bg-white flex flex-col justify-between min-h-[140px]"
                >
